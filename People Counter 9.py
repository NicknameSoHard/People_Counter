...
w = cap.get(3)
h = cap.get(4)
areaTH = (h*w)/100 # Делим высоту и длину кадра на выбранный коэфициент. Его мы подбираем из соображений наилучшего обнаружения
print ('Угу. Без балласта никуда)Area Threshold', areaTH) #Область захвата
...
pt1 =  [0, line_down]; # координаты "краев" линии
pt2 =  [w, line_down];
